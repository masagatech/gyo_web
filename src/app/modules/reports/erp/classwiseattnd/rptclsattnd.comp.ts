...
@Component({
    templateUrl: 'rptclsattnd.comp.html'
})

export class ClassWiseAttednacneReportsComponent implements OnInit, OnDestroy {
    ...
    public getClassWiseAttendance(format) {
        var that = this;

        var dparams = {
            "flag": "clswiseattnd", "type":"download", "status": "a", "attndmonth": that.attndmonth, "attndtype": that.attndtype,
