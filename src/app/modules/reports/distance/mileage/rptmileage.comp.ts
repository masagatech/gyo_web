...
@Component({
    templateUrl: 'rptmileage.comp.html',
    providers: [CommonService]
})

export class MileageReportsComponent implements OnInit, OnDestroy {
    ...
    private getMileageReports(format) {
        let that = this;
        let params = {};
        ...
        params = {
            "flag": that.flag, "rpttype": "mileage", "vhid": that.vehids, "frmdt": that.frmdt, "todt": that.todt,
