...
export class ViewPassengerLeaveComponent implements OnInit {
    ...
    public addPassengerLeave() {
        this._router.navigate(['/master/' + this._enttdetails.smpsngrtype + 'leave/add']);
    }

    public editPassengerLeave(row) {
        this._router.navigate(['/master/' + this._enttdetails.smpsngrtype + 'leave/edit', row.slid]);
    }

    public openApprovalLeave(row) {
        this._router.navigate(['/master/' + this._enttdetails.smpsngrtype + 'leave/approval', row.key.split(':')[0]]);
    }
}
