...
export class ViewTransportNotificationComponent implements OnInit {
    ...
    public addNotification() {
        this._router.navigate(['/transport/notification/add']);
    }

    public editNotification(row) {
        this._router.navigate(['/transport/notification/edit', row.ntfid]);
    }
}
